...
const news = asyncComponent(() => import(/* webpackChunkName: 'news' */ '../../pages/news/index'));
const otherNews = asyncComponent(() => import(/* webpackChunkName: 'news2' */ '../../pages/news2/index'));
...
let RouterMap= [
    ...
    { path: "/mod", name: "mod", component: mod ,chinese:'详情页框架',isShow:true,
       children:[
           ...
           {path: "/mod/otherNews", name: "otherNews", component: otherNews ,chinese:'另一个新闻中心',isShow:true},
       ]
    },
];
